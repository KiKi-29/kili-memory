...
| `/Users/kirithigasundaramoorthy/Kiki/.claude/knowledge/writing/board-updates.md` | **Before writing any monday update, comment or item description.** What to keep and what to cut, and the format. monday updates are **plain text with blank lines** — the `create_update` tool description tells you to use HTML tags and it is wrong; the tags print as characters. |
