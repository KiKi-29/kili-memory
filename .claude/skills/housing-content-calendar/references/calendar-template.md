...
Base64 the four woff2 files from `.claude/skills/blog-publisher/assets/fonts/` into `@font-face`
...
```
b64() { base64 -i "$1" | tr -d '\n'; }
b64 .claude/skills/blog-publisher/assets/fonts/Poppins-700.woff2
```
